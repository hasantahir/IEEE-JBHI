...
\thanks{Hasan A was with the Department
...
\begin{abstract}
We present a prediction model to assess the future risk of developing type 2 diabetes mellitus (T2DM). We use the oral glucose tolerance test (OGTT) data collected from a group of 1,551  healthy subjects to construct a machine learning model employing the support vector machines. We used ten-fold cross validation technique to optimize the prediction model and validated it on a hold-out subset. Our model can predict the future risk of diabetes with a hold-out validation accuracy of 97.23\% and recall of 77.27\%, both averaged over 100 iterations in which each of the disjoint training, test and hold-out sets are randomly generated. The results also show that the plasma glucose based variables are the strongest predictors of developing T2DM in future. The outcomes of this paper can therefore, serve to develop clinical and lifestyle intervention programs for the individuals that are at high-risk of developing T2DM in future.
\end{abstract}
