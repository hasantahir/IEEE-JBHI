...
\begin{table}[!h]
  ...
  \centering
  \begin{tabularx}{.85\columnwidth}{c c c c}
    \toprule
     &  Accuracy (SD) & Hit Rate (SD) & Specificity (SD)\\
    \midrule \midrule
    Linear SVM (Balanced) & \SI{78.73}{\percent} (\num{0.014}) & \SI{77.77}{\percent} (\num{0.012}) & \SI{79.69}{\percent} (\num{0.023})\\
    Linear SVM (Unbalanced) & \SI{79.74}{\percent} (\num{0.0043}) & \SI{77.81}{\percent} (\num{0.009}) & \SI{80.00}{\percent} (\num{0.004}) \\
    SVM-RBF (Balanced) & \SI{78.95}{\percent} (\num{0.019}) & \SI{79.07}{\percent} (\num{0.022}) & \SI{78.84}{\percent} (\num{0.026})\\
    SVM-RBF (Unbalanced) & \SI{78.51}{\percent} (\num{0.008}) & \SI{78.13}{\percent} (\num{0.013}) & \SI{78.57}{\percent} (\num{ 0.010})\\
    \bottomrule \\
  \end{tabularx}
  \label{tab:training}
...
\begin{table}[!h]
  ...
  \tiny
  \renewcommand{\arraystretch}{1.3}
  \caption{ Mean Training performance classifiers}
  \centering
  \begin{tabularx}{.85\columnwidth}{c c c c}
    \toprule
     &  Accuracy (SD) & Hit Rate (SD) & Specificity (SD)\\
    \midrule \midrule
    Linear SVM (Balanced) & \SI{97.29}{\percent} (\num{0.014}) & \SI{76.82}{\percent} (\num{0.119}) & \SI{100}{\percent} (\num{0})\\
    Linear SVM (Unbalanced) & \SI{97.19}{\percent} (\num{0.015}) & \SI{76.82}{\percent} (\num{0.127}) & \SI{99.89}{\percent} (\num{0.004}) \\
    SVM-RBF (Balanced) & \SI{97.62}{\percent} (\num{0.015}) & \SI{79.64}{\percent} (\num{0.127}) & \SI{100}{\percent} (\num{0})\\
    SVM-RBF (Unbalanced) & \SI{98.51}{\percent} (\num{0.014}) & \SI{87.27}{\percent} (\num{0.115}) & \SI{100}{\percent} (\num{0})\\
    \bottomrule \\
  \end{tabularx}
